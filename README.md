...
Для быстрого обновления кода, без остановки функционирования сайта, в проекте предусмотрен bash-скрипт, расположенный в репозитории
`autodeploy.sh`.
...
В случае успешного завершения всех операций Вы увидите в следующе сообщение: "Congratulations! Project deployment is completed succesfully."
