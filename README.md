...
-`YANDEX_GEOCODER_KEY` в значение данной переменной поместите значение ключа от API геокодера "Яндекс"
[см. первые шаги](https://dvmn.org/encyclopedia/api-docs/yandex-geocoder-api/)
